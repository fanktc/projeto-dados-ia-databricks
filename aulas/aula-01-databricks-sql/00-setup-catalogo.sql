...
CREATE SCHEMA IF NOT EXISTS rota_perfume.bronze
  COMMENT 'Ingestão crua. O dado como veio da origem, sujeira inclusa.';
CREATE SCHEMA IF NOT EXISTS rota_perfume.silver
  COMMENT 'Limpo, deduplicado e tipado. Preenchido na noite 2.';
CREATE SCHEMA IF NOT EXISTS rota_perfume.gold
...
CREATE VOLUME IF NOT EXISTS rota_perfume.bronze.raw
